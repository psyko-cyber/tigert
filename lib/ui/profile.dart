...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PageBody(children: [
      ...
      const SectionLabel('Allenamento'),
      ...
      const SectionLabel('Voto e promemoria'),
      ...
      const SectionLabel('PC, telefono e dati'),
      ListenableBuilder(
    ...
    return Padding(
      ...
      child: TCard(
        ...
        child: Row(children: [
          ...
          ConstrainedBox(constraints: const BoxConstraints(maxWidth: 190), child: Text(k, style: TextStyle(fontSize: 14, color: t.ink))),
          const SizedBox(width: 10),
          Expanded(child: Text(v, textAlign: TextAlign.right, style: TS.muted(t, 12.5), maxLines: 1, overflow: TextOverflow.ellipsis)),
